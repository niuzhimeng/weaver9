 ...
 * 员工辞退申请单
 */
public class CiTuiAction extends BaseAction {
    ...
    public String execute(RequestInfo requestInfo) {
        ...
        this.writeLog("员工辞退申请单 Start requestid=" + requestId + "  operatetype --- " + operateType + "   fromTable --- " + tableName);
        try {
            ...
            String bctr = recordSet.getString("bctr");  // 被辞退人
            ...
            if (StringUtils.isBlank(rzrq)) {
                ...
                updateSet.executeUpdate(mainUpdateSql, hour, bctr, year, month);
                return "1";
            }
            ...
            this.writeLog("员工辞退申请单 End ===============");
        } catch (Exception e) {
            this.writeLog("员工辞退申请单 Error： " + e);
            requestInfo.getRequestManager().setMessageid("110000");
            requestInfo.getRequestManager().setMessagecontent("员工辞退申请单  Error： " + e);
            return "0";
        }
